...
- [ ] T154 Add post-optimization performance threshold assertions and diagnostics evidence hooks in `backend/tests/InvestmentTracker.Application.Tests/UseCases/StockTransactions/PreviewStockImportPerformanceTests.cs` and `specs/012-import-broker-statement/quickstart.md`
