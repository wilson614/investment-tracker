...
- [ ] T159 Fix XIRR cash-flow timeline construction for imported baseline plus same-day trades in `backend/src/InvestmentTracker.Application/Services/HistoricalPerformanceService.cs` and `backend/src/InvestmentTracker.Domain/Services/ReturnCalculator.cs`
