...
namespace InvestmentTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260221084047_AddMtmInitializationFieldsToStockTransaction")]
    partial class AddMtmInitializationFieldsToStockTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("ActualInterest")
                        .HasPrecision(18, 2)
                    ...
                    b.Property<int?>("FixedDepositStatus")
                        .HasColumnType("integer");

                    b.Property<decimal>("InterestCap")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.BenchmarkAnnualReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("PriceReturnPercent")
                        .HasPrecision(10, 4)
                    ...
                    b.ToTable("benchmark_annual_returns", (string)null);
                });
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.CreditCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.FundAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("fund_allocations", (string)null);
                });
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.Installment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.Portfolio", b =>
                {
                    ...
                    b.Property<Guid>("BoundCurrencyLedgerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.StockTransaction", b =>
                {
                    ...
                    b.Property<decimal?>("HistoricalTotalCost")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal?>("MarketValueAtImport")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.TransactionPortfolioSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("PortfolioValueAfterHome")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("PortfolioValueAfterSource")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("PortfolioValueBeforeHome")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("PortfolioValueBeforeSource")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.HasIndex("PortfolioId", "TransactionId")
                        .IsUnique()
                        .HasDatabaseName("IX_TransactionPortfolioSnapshots_PortfolioId_TransactionId");

                    b.ToTable("transaction_portfolio_snapshots", (string)null);
                });

            modelBuilder.Entity("InvestmentTracker.Domain.Entities.TwSecurityMapping", b =>
                {
                    b.Property<string>("Ticker")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.ToTable("tw_security_mappings", (string)null);
                });
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.Installment", b =>
                {
                    b.HasOne("InvestmentTracker.Domain.Entities.CreditCard", "CreditCard")
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.Portfolio", b =>
                {
                    b.HasOne("InvestmentTracker.Domain.Entities.CurrencyLedger", "BoundCurrencyLedger")
                        .WithMany()
                    ...
                    b.Navigation("BoundCurrencyLedger");
