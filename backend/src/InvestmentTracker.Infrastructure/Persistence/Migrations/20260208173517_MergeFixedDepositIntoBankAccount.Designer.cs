...
namespace InvestmentTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260208173517_MergeFixedDepositIntoBankAccount")]
    partial class MergeFixedDepositIntoBankAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.FixedDeposit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("fixed_deposits", (string)null);
                });
            ...
            modelBuilder.Entity("InvestmentTracker.Domain.Entities.FixedDeposit", b =>
                {
                    b.HasOne("InvestmentTracker.Domain.Entities.BankAccount", "BankAccount")
                        .WithMany()
