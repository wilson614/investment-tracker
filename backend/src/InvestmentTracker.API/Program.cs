...
builder.Services.AddScoped<IStockImportSessionStore, StockImportSessionStore>();
...
builder.Services.AddScoped<IQueryStockImportSessionUseCase, QueryStockImportSessionUseCase>();
...
builder.Services.AddScoped<CalculateAggregateXirrUseCase>();
builder.Services.AddScoped<GetAggregateAvailableYearsUseCase>();
builder.Services.AddScoped<CalculateAggregateYearPerformanceUseCase>();
