...
public class TotalAssetsServiceTests
{
    ...
    [Fact]
    public void Calculate_WithEmptyBankAccounts_ReturnsInvestmentOnly()
    {
    ...
    [Fact]
    public void Calculate_WithBankAccounts_CalculatesTotalsAndPercentages()
    {
    ...
    [Fact]
    public void Calculate_WithZeroGrandTotal_ReturnsZeroPercentages()
    {
        var userId = Guid.NewGuid();

        var accounts = new List<BankAccount>
        {
            new(userId, "A", totalAssets: 0m, interestRate: 3.0m, interestCap: 300_000m)
        };
